# REPLAY DATA CARD — btc15m point-in-time replay, 2026-02-01 → 2026-02-28
...
| Quantity | Value |
|---|---|
| Events attempted (15-min windows, open in Feb) | 2688 |
| Events emitted | 2688 |
| Rows attempted (7 decision points per event) | 18816 |
| Rows emitted | 18813 |
| Rows excluded (by reason) | 3 — context_invalid:donnees_insuffisantes:klines(1/11,fresh:injected)=1; context_invalid:donnees_insuffisantes:klines(6/11,fresh:injected)=1; context_invalid:donnees_insuffisantes:klines(8/11,fresh:injected)=1 |
| Events excluded (by reason) | 0 — none |
| Ties (close at expiry == strike) | 7 |
| Base rate of y, row-level | 0.4981 (9370/18813) |
| Base rate of y, event-level | 0.4981 (1339/2688) |
| Momentum-cap binding rate, pooled | **53.7%** (10108 rows) |
| Momentum-cap binding rate per horizon | t=1: 20.3%; t=2: 36.0%; t=3: 46.5%; t=5: 59.3%; t=8: 68.8%; t=10: 72.4%; t=15: 72.8% |
...
| Git SHA (engine) | `7a1195ac6b5a67321c3376aa3e83b1e1516e83f1` |
| Runtime | 4.4 s |
...
- events_attempted = 2688 = 28 days × 96 windows; rows_attempted = 18816.
- rows_emitted = 18813; rows_excluded = 3: context_invalid:donnees_insuffisantes:klines(1/11,fresh:injected)=1; context_invalid:donnees_insuffisantes:klines(6/11,fresh:injected)=1; context_invalid:donnees_insuffisantes:klines(8/11,fresh:injected)=1.
- events_emitted = 2688; events_excluded = 0: none.
